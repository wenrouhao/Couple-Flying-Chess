(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["pages-index-index~pagesA-chess-chess"],
  {
    ...
    1840: function (t, e, a) {
      ...
      r("740959f7", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "1dd4": function (t, e, a) {
      var n = a("6f52");
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var r = a("4f06").default;
      r("08cc9302", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    3256: function (t, e, a) {
      "use strict";
      a.r(e);
    ...
    3909: function (t, e, a) {
      ...
      var n = { uTransition: a("7b02").default },
        r = function () {
          var t = this,
            e = t.$createElement,
            a = t._self._c || e;
          ...
          methods: {
                      ...
                      return (0, r.default)().wrap(function (a) {
                        while (1)
                          switch ((a.prev = a.next)) {
                            case 0:
                              return (a.next = 2), uni.$u.sleep(20);
                            case 2:
                              t.$emit("enter"),
                                (t.transitionEnded = !1),
                                t.$emit("afterEnter"),
                                (t.classes = e["enter-to"]);
                            case 6:
                            case "end":
                              return a.stop();
                          }
            ...
            vueLeave: function () {
              ...
              if (this.display) {
                ...
                (this.status = "leave"),
                  ...
                  (this.classes = e.leave),
                  this.$nextTick(function () {
                    (t.transitionEnded = !1),
                      t.$emit("leave"),
                      setTimeout(t.onTransitionEnd, t.duration),
            ...
            onTransitionEnd: function () {
              this.transitionEnded ||
                ...
                this.$emit(
                  "leave" === this.status ? "afterLeave" : "afterEnter"
                ),
                !this.show &&
                  this.display &&
    ...
    "6cee": function (t, e, a) {
      ...
      var n = {
        props: {
          show: { type: Boolean, default: uni.$u.props.transition.show },
          mode: { type: String, default: uni.$u.props.transition.mode },
          duration: {
            type: [String, Number],
    ...
    "88ce": function (t, e, a) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var r = a("4f06").default;
      r("13c29c74", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "8c1a": function (t, e, a) {
      "use strict";
      var n = a("1840"),
    ...
    "8c41": function (t, e, a) {
      ...
      var n = {
          uOverlay: a("9693").default,
          uTransition: a("7b02").default,
          uStatusBar: a("9a99").default,
          uIcon: a("a6a2").default,
          uSafeBottom: a("9673").default,
        },
        r = function () {
          var t = this,
            e = t.$createElement,
              ...
              t.overlay
                ? a("u-overlay", {
                    ...
                    on: {
                      click: function (e) {
                        (arguments[0] = e = t.$handleEvent(e)),
                          t.overlayClick.apply(void 0, arguments);
                      },
                    },
                  })
                : t._e(),
                ...
                "u-transition",
                {
                  ...
                  on: {
                    afterEnter: function (e) {
                      (arguments[0] = e = t.$handleEvent(e)),
                        t.afterEnter.apply(void 0, arguments);
                    },
                    click: function (e) {
                      (arguments[0] = e = t.$handleEvent(e)),
                        t.clickHandler.apply(void 0, arguments);
                    ...
                    "v-uni-view",
                    {
                      ...
                      on: {
                        click: function (e) {
                          e.stopPropagation(),
                            (arguments[0] = e = t.$handleEvent(e)),
                            t.noop.apply(void 0, arguments);
                        },
                      },
                    },
                    [
                      t.safeAreaInsetTop ? a("u-status-bar") : t._e(),
                      t._t("default"),
                      t.closeable
                        ? a(
                            "v-uni-view",
                            {
                              ...
                              class: [
                                "u-popup__content__close--" + t.closeIconPos,
                              ],
                              attrs: {
                        ...
                        : t._e(),
                      t.safeAreaInsetBottom ? a("u-safe-bottom") : t._e(),
                    ],
                    2
                  ),
                ],
    ...
    "8d66": function (t, e, a) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var r = a("4f06").default;
      r("127197e0", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    9639: function (t, e, a) {
      "use strict";
      a.d(e, "b", function () {
    ...
    a4d0: function (t, e, a) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var r = a("4f06").default;
      r("3786eee4", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    ae84: function (t, e, a) {
      "use strict";
      a("7a82");
    ...
    d579: function (t, e, a) {
      ...
      var n = {
        props: {
          show: { type: Boolean, default: uni.$u.props.popup.show },
          overlay: { type: Boolean, default: uni.$u.props.popup.overlay },
          mode: { type: String, default: uni.$u.props.popup.mode },
          duration: {
            type: [String, Number],
            default: uni.$u.props.popup.duration,
          },
          closeable: { type: Boolean, default: uni.$u.props.popup.closeable },
          overlayStyle: {
            type: [Object, String],
          ...
          zoom: { type: Boolean, default: uni.$u.props.popup.zoom },
          bgColor: { type: String, default: uni.$u.props.popup.bgColor },
          overlayOpacity: {
            type: [Number, String],
    ...
    d59c: function (t, e, a) {
      ...
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */uni-view[data-v-2f0e5305], uni-scroll-view[data-v-2f0e5305], uni-swiper-item[data-v-2f0e5305]{display:flex;flex-direction:column;flex-shrink:0;flex-grow:0;flex-basis:auto;align-items:stretch;align-content:flex-start}.u-line[data-v-2f0e5305]{vertical-align:middle}',
          "",
        ]),
        (t.exports = e);
    },
    dd23: function (t, e, a) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var r = a("4f06").default;
      r("2a1ed524", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    e023: function (t, e, a) {
      "use strict";
      a("7a82"),
    ...
    ebeb: function (t, e, a) {
      ...
      var n = {
        props: {
          show: { type: Boolean, default: uni.$u.props.overlay.show },
          zIndex: {
            type: [String, Number],
      ...
      var r = n(a("d579")),
        o = {
          ...
          computed: {
            transitionStyle: function () {
              ...
              return (
                ...
                "left" === this.mode || "right" === this.mode
                  ? uni.$u.deepMerge(t, { bottom: 0, top: 0 })
                  : "top" === this.mode || "bottom" === this.mode
                  ? uni.$u.deepMerge(t, { left: 0, right: 0 })
                  : "center" === this.mode
                  ? uni.$u.deepMerge(t, {
                      alignItems: "center",
            ...
            contentStyle: function () {
              ...
              if (
                ...
                var a = uni.$u.addUnit(this.round);
                "top" === this.mode
                  ? ((t.borderBottomLeftRadius = a),
                    (t.borderBottomRightRadius = a))
                  : "bottom" === this.mode
                  ? ((t.borderTopLeftRadius = a), (t.borderTopRightRadius = a))
                  : "center" === this.mode && (t.borderRadius = a);
              }
              return uni.$u.deepMerge(t, uni.$u.addStyle(this.customStyle));
            },
            position: function () {
          ...
          methods: {
            ...
            clickHandler: function () {
              "center" === this.mode && this.overlayClick(),
                this.$emit("click");
            },
          },
        };
